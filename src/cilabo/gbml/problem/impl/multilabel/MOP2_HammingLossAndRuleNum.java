...
public class MOP2_HammingLossAndRuleNum extends AbstractPitssburghGBML_Problem<IntegerSolution> {
	...
	public void evaluate(IntegerSolution solution) {
		...
		/* The first objective */
		Metric function1 = new HammingLoss();
